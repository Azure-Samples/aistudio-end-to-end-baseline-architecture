...
param deployDNS bool = true // Add this line to declare the deployDNS parameter
...
resource openaiDnsZone 'Microsoft.Network/privateDnsZones@2020-06-01' =if (deployDNS) {
  name: openaiDnsZoneName
  location: 'global'
  properties: {}
}

resource openaiDnsZoneLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = if (deployDNS){
...
resource openaiDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-11-01' =   if (deployDNS){
